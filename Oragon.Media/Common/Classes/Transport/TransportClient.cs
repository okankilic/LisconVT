...
namespace Oragon.Classes.Transport
{
    //TransportSession? => Id 
    ...
    public class TransportClient : SuppressedFinalizerDisposable, ISocketReference, IThreadReference
    {
        ...
        //public readonly System.Collections.Generic.List<IPacket> Outbound;
