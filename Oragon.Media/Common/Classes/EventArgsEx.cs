...
namespace Oragon.Classes
{
    ...
    internal struct EventReferenceInformation<T> : IEvent, IDisposed
    {
        ...
        {
            EventReferenceInformationExtensions.Consume(this, Consumed, optional);
        }

        bool IEvent.Enabled
        {
            get { return IDisposedExtensions.IsNullOrDisposed(this).Equals(false) && IEventExtensions.IsEnabled(this); }
        }
    ...
    internal static class EventReferenceInformationExtensions
    {
        ...
        {
            if (IEventExtensions.IsNull(@event)) return;
