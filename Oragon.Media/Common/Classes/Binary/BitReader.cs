...
namespace Oragon.Classes.Binary//.Binary
{
    /// <summary>
    ...
    public class BitReader : BaseDisposable
    {
        ...
        /// </summary>
        public int BitsRemaining { get { return Binary.BitsPerByte - m_BitIndex; } }
        ...
        internal void ReadBytesForBits(int countOfBits)
        {
            ...
            int bitsRemain = Binary.BitsPerByte - m_BitIndex;

            if (bitsRemain < countOfBits) return;

            int bytesToRead = Binary.BitsToBytes(countOfBits);
        ...
        internal void Recycle()
        {
            ...
            Binary.CopyBitsTo(m_ByteCache.Array, m_ByteIndex, m_BitIndex, m_ByteCache.Array, 0, 0, Binary.BytesToBits(m_ByteCache.Count - m_ByteIndex) + m_BitIndex);
        ...
        public bool PeekBit()
        {
            return Binary.GetBit(ref m_ByteCache.Array[m_ByteIndex], m_BitIndex);
        }

        public byte Peek8(bool reverse = false)
        {
            int bits = Binary.BytesToBits(ref m_ByteIndex) + m_BitIndex;

            return (byte)(reverse ? Binary.ReadBitsMSB(m_ByteCache.Array, bits, Binary.BitsPerByte) : Binary.ReadBitsLSB(m_ByteCache.Array, bits, Binary.BitsPerByte));
        }
        ...
        public short Peek16(bool reverse = false)
        {
            ...
            return (short)(reverse ? Binary.ReadBitsMSB(m_ByteCache.Array, bits, Binary.BitsPerShort) : Binary.ReadBitsLSB(m_ByteCache.Array, bits, Binary.BitsPerShort));
        }
        ...
        public int Peek24(bool reverse = false)
        {
            ...
            return (int)(reverse ? Binary.ReadBitsMSB(m_ByteCache.Array, bits, Binary.TripleBitSize) : Binary.ReadBitsLSB(m_ByteCache.Array, bits, Binary.TripleBitSize));
        }
        ...
        public int Peek32(bool reverse = false)
        {
            ...
            return (int)(reverse ? Binary.ReadBitsMSB(m_ByteCache.Array, bits, Binary.BitsPerInteger) : Binary.ReadBitsLSB(m_ByteCache.Array, bits, Binary.BitsPerInteger));
        }
        ...
        public long Peek64(bool reverse = false)
        {
            ...
            return (int)(reverse ? Binary.ReadBitsMSB(m_ByteCache.Array, bits, Binary.BitsPerLong) : Binary.ReadBitsLSB(m_ByteCache.Array, bits, Binary.BitsPerLong));
        }
        ...
        public ulong PeekBits(int count, bool reverse = false)
        {
            ...
            return (reverse ? Binary.ReadBitsMSB(m_ByteCache.Array, bits, count) : Binary.ReadBitsLSB(m_ByteCache.Array, bits, count));
        }
        ...
        public bool ReadBit()
        {
            if (m_BitIndex > Binary.BitsPerByte)
            {
                m_BitIndex = 0;
        ...
        public void CopyBits(int count, byte[] dest, int destByteOffset, int destBitOffset)
        {
            ...
            Binary.CopyBitsTo(m_ByteCache.Array, m_ByteIndex, m_BitIndex, dest, destByteOffset, destBitOffset, count);
        }
