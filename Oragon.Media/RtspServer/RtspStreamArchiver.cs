...
namespace Oragon.Media.RtspServer
{
    public class RtspStreamArchiver : BaseDisposable
    {
        ...
        IDictionary<IMedia, Program> Attached = new System.Collections.Concurrent.ConcurrentDictionary<IMedia, Program>();
        ...
        public virtual void WritePacket(IMedia stream, IPacket packet)
        {
        ...
        public virtual void Start(IMedia stream, FileFormat format = FileFormat.Binary)
        {
            ...
            if (stream is RtpSource)
            {
                ...
                program = new Program(); //.DumpWriter(BaseDirectory + '/' + stream.Id + '/' + DateTime.UtcNow.ToFileTime(), format, new System.Net.IPEndPoint(System.Net.IPAddress.Any, 0));
        ...
        void RtpClientPacketReceieved(object sender, IPacket packet = null, Media.Rtp.RtpClient.TransportContext tc = null)
        {
        ...
        public virtual void Stop(IMedia stream)
        {
            if (stream is RtpSource)
            {
                ...
                if (program != null && false == IDisposedExtensions.IsNullOrDisposed(program.Writer)) program.Writer.Dispose();
