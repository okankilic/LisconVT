...
namespace Oragon.Media.Container
{
    ...
    /// </summary>
    public abstract class MediaFileStream : System.IO.FileStream, IDisposable, IDisposed, Container.IMediaContainer
    {
        #region Statics
    ...
    //public class IdentifierTransaction : StreamExtensions.ReadTransaction
    //{
